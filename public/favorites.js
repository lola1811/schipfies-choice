const FAVORITES = [
  {
    id: "vogerlsalat",
    title: "Vogerlsalat mit Kürbiskernöl & Knoblauch",
    subtitle: "Österreichischer Klassiker — optional mit Ei & Kartoffeln",
    tags: ["schnell", "österreichisch", "Lola+Luki"],
    ...
    ingredients: [
      ...
      {amount: "3", unit: "EL", name: "Steirisches Kürbiskernöl"},
    ...
    steps: [
      ...
      "Dressing: Kürbiskernöl, Weißweinessig, Knoblauch, Salz & Pfeffer verrühren.",
      "Optional: Kartoffeln kochen, würfeln, noch warm zum Salat geben.",
      "Optional: Eier hartkochen, vierteln, dazu legen.",
      "Dressing über den Salat geben, sofort servieren."
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      {amount: "400", unit: "g", name: "stückige Tomaten (Dose)"},
    ...
    steps: [
      ...
      "Stückige Tomaten und Kräuter unterrühren.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      {amount: "1", unit: "Stück", name: "Ingwer (daumengroß), gerieben"},
      {amount: "2", unit: "TL", name: "Currypulver"},
      {amount: "1", unit: "TL", name: "Kurkuma"},
      {amount: "1", unit: "", name: "Dose stückige Tomaten"},
      {amount: "2", unit: "EL", name: "Kokosöl"},
      {amount: "", unit: "", name: "Reis als Beilage"}
    ],
    steps: [
      "Rote Linsen waschen und abtropfen lassen. Reis aufsetzen.",
      "Zwiebel, Knoblauch und Ingwer in Kokosöl anschwitzen.",
      "Currypulver und Kurkuma kurz mitrösten.",
      "Linsen, Tomaten, Kokosmilch und Brühe dazugeben.",
      "15–20 Min köcheln lassen bis die Linsen weich sind.",
  ...
  },
  {
    ...
    ingredients: [
      ...
      {amount: "200", unit: "g", name: "Tofu, gewürfelt"},
      {amount: "3", unit: "EL", name: "Sojasauce"},
      {amount: "1", unit: "EL", name: "Sesamöl"},
      {amount: "1", unit: "Stück", name: "Ingwer, gerieben"},
      {amount: "2", unit: "", name: "Knoblauchzehen"},
      {amount: "", unit: "", name: "Sesam & Frühlingszwiebeln zum Toppen"},
      {amount: "", unit: "", name: "Reis oder Nudeln als Beilage"}
    ],
    steps: [
      "Tofu in Würfel schneiden und in Sesamöl knusprig anbraten, rausnehmen.",
      "Knoblauch und Ingwer kurz anbraten.",
      "Hartes Gemüse zuerst (Karotten, Brokkoli), dann weiches Gemüse dazu.",
      "Mit Sojasauce ablöschen, Tofu zurück dazu.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Zitronensaft, Abrieb und 2–3 EL Pastawasser in die Pfanne.",
      "Pasta dazu, schwenken bis eine cremige Sauce entsteht.",
      "Scampi zurück dazu, mit Basilikum und Chiliflocken servieren."
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      {amount: "750", unit: "ml", name: "Gemüsebrühe"},
      {amount: "1", unit: "", name: "Zwiebel"},
      {amount: "2", unit: "EL", name: "Olivenöl"},
      {amount: "1", unit: "Prise", name: "Muskatnuss"},
      {amount: "", unit: "", name: "Salz, Pfeffer, frische Kräuter"}
    ],
    steps: [
      "Zwiebel und Lauch in Olivenöl anschwitzen.",
      "Karotten und Kartoffel dazugeben, kurz mitbraten.",
      "Mit Gemüsebrühe aufgießen, 20 Min köcheln lassen.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Alles anrichten, mit Pinienkernen und Fenchelgrün toppen."
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      {amount: "1", unit: "", name: "Kartoffel, gewürfelt"},
      {amount: "1", unit: "", name: "Zwiebel"},
      {amount: "600", unit: "ml", name: "Gemüsebrühe"},
      {amount: "100", unit: "ml", name: "Hafercreme"},
      {amount: "2", unit: "EL", name: "Olivenöl"},
      {amount: "", unit: "", name: "Salz, Pfeffer, Fenchelgrün"}
    ],
    steps: [
      "Zwiebel in Olivenöl anschwitzen, Fenchel und Kartoffel dazu.",
      "Mit Gemüsebrühe aufgießen, 20 Min köcheln.",
      "Pürieren, Hafercreme einrühren.",
      "Mit Fenchelgrün und gerösteten Kernen servieren."
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      {amount: "", unit: "", name: "Granatapfelkerne, frische Kräuter, Pinienkerne"}
    ],
    steps: [
      "Ofen auf 220°C vorheizen.",
      "Blumenkohl mit Olivenöl und Gewürzen mischen.",
      "Auf ein Backblech verteilen, 25 Min rösten bis goldbraun.",
      "Tahini mit Zitronensaft und etwas Wasser zu einem Dressing verrühren.",
      "Blumenkohl mit Tahini-Dressing, Granatapfelkernen und Kräutern servieren."
    ],
  ...
  },
  {
    ...
    ingredients: [
      ...
      {amount: "2", unit: "EL", name: "Kecap Manis (süße Sojasauce)"},
      {amount: "1", unit: "EL", name: "Sojasauce"},
      {amount: "1", unit: "EL", name: "Sesamöl"},
      {amount: "2", unit: "", name: "Knoblauchzehen"},
      {amount: "1", unit: "Stück", name: "Ingwer"},
      {amount: "2", unit: "", name: "Eier (optional)"},
      {amount: "", unit: "", name: "Frühlingszwiebeln, Limette"}
    ],
    steps: [
      "Nudeln nach Packung kochen, abgießen.",
      "Knoblauch und Ingwer in Sesamöl anbraten.",
      "Gemüse dazu, 3-4 Min pfannenrühren.",
      "Nudeln, Kecap Manis und Sojasauce dazu, alles gut vermengen.",
      "Optional: Eier in der Mitte der Pfanne verquirlen.",
      "Mit Frühlingszwiebeln und Limette servieren."
    ],
